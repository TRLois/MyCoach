   ...
   ?>
    ...
    <section id="presentation">
        <div class="wrapper">
            ...
            <div class="clear"></div>
            <a href="presentation.html" class="button-1">Me découvrir</a>
        </div>
    </section>
        ...
        <div class="wrapper">
            <h3>Les différentes activités que je propose</h3>
                <ul>
                    <li>
                        <h3>Le yoga</h3>
                        <p>Je propose des séances yoga afin de vous relaxer et découvrir les biens faits de votre corps</p>
                        <a href="yoga.html" class="button-2">En savoir plus</a>
                    </li>

                    <li>
                        <h3>Le step</h3>
                        <p>Je propose des séances yoga afin de vous relaxer et découvrir les biens faits de votre corps</p>
                        <a href="pilates.html" class="button-2">En savoir plus</a>
                    </li>

                    <li>
                        <h3>Cardio training</h3>
                        <p>Je propose des séances yoga afin de vous relaxer et découvrir les biens faits de votre corps</p>
                        <a href="cardio.html" class="button-2">En savoir plus</a>
                    </li>

                    <li>
                        <h3>Musculation</h3>
                        <p>Je propose des séances yoga afin de vous relaxer et découvrir les biens faits de votre corps</p>
                        <a href="musculation.html" class="button-2">En savoir plus</a>
                    </li>

                    <li>
                        <h3>Fitness</h3>
                        <p>Je propose des séances yoga afin de vous relaxer et découvrir les biens faits de votre corps</p>
                        <a href="seance.html" class="button-2">Voir mes séances</a>
                    </li>
                </ul>
        </div>
    </section>
